...
Book.create!(
  [
    {title: 'リーダブルコード', body: 'より良いコードを書くためのシンプルで実践的なテクニック。', user_id: users[0].id, evaluation: 5 },
    {title: 'トラブル知らずのシステム設計', body: 'システム設計の要点を図解で説明してくれます。', user_id: users[1].id, evaluation: 4 },
    {title: 'たのしいRuby', body: 'Rubyの入門におすすめです。', user_id: users[2].id, evaluation: 2 },
  ]
)